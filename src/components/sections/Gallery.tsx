...
export function Gallery() {
  return (
    <section id="gallery" className="w-full overflow-hidden bg-bg-primary py-20 md:py-28">
      ...
      <div className="scroll-track-paused mb-4 overflow-hidden">
        <div className="scroll-track-right flex w-max gap-4 px-6 md:px-12 lg:px-20">
      ...
      <div className="scroll-track-paused overflow-hidden">
        <div className="scroll-track-left flex w-max gap-4 px-6 md:px-12 lg:px-20">
